...
const LoginPage = () => {
  ...
  return (
    <div className='relative p- bg-gray-50 dark:bg-blue-950 flex items-center rounded-lg w-5/6 md:w-4/6 min-w-[256px] md:h-[620px] shadow-md shadow-gray-700 mt-16 mx-auto gap-4 overflow-hidden'>
